...
// website url
export const WEBSITE_URL = process.env.VITE_WEBSITE_URL || "https://darkalphacapital.com";
// support email
export const SUPPORT_EMAIL = process.env.VITE_SUPPORT_EMAIL || "support@darkalphacapital.com";
// marketing links
export const MARKETING_PRICING_PAGE_LINK = "https://darkalphacapital.com";
export const MARKETING_CONTACT_US_PAGE_LINK = "https://darkalphacapital.com/contact";
export const MARKETING_PLANE_ONE_PAGE_LINK = "https://darkalphacapital.com";
