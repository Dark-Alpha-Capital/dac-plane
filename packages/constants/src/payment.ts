...
export const PLANE_COMMUNITY_PRODUCTS: Record<string, IPaymentProduct> = {
  ...
  [EProductSubscriptionEnum.BUSINESS]: {
    ...
    name: "DAC Business",
    description:
      "The earliest packaging of Business at $10 a seat a month billed annually, $12 a seat a month billed monthly for DAC Cloud",
    type: "BUSINESS",
    prices: [
      {
 ...
 */
export const TALK_TO_SALES_URL = "https://darkalphacapital.com/contact";
...
export const SUBSCRIPTION_REDIRECTION_URLS: Record<EProductSubscriptionEnum, Record<TBillingFrequency, string>> = {
  ...
  [EProductSubscriptionEnum.PRO]: {
    month: "https://dac.darkalphacapital.com/upgrade/pro/self-hosted?plan=month",
    year: "https://dac.darkalphacapital.com/upgrade/pro/self-hosted?plan=year",
  },
  [EProductSubscriptionEnum.BUSINESS]: {
    month: "https://dac.darkalphacapital.com/upgrade/business/self-hosted?plan=month",
    year: "https://dac.darkalphacapital.com/upgrade/business/self-hosted?plan=year",
  },
  [EProductSubscriptionEnum.ENTERPRISE]: {
    month: TALK_TO_SALES_URL,
    year: TALK_TO_SALES_URL,
...
export const SUBSCRIPTION_WEBPAGE_URLS: Record<EProductSubscriptionEnum, string> = {
  ...
  [EProductSubscriptionEnum.PRO]: "https://darkalphacapital.com",
  [EProductSubscriptionEnum.BUSINESS]: "https://darkalphacapital.com",
  [EProductSubscriptionEnum.ENTERPRISE]: "https://darkalphacapital.com",
};
