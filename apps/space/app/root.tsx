...
const APP_TITLE = "Dark Alpha Capital Publish | Make your boards public with one-click";
const APP_DESCRIPTION = "Dark Alpha Capital Publish is a customer feedback management tool for elite teams";
